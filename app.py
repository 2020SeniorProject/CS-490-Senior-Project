    ...
    if request.method == "POST":
        if request.form['type'] == "delete":
            ...
            if form.validate():
                ...
                return render_template("edit_character.html", message_text=form.errors, name=form.name.data, hp=form.hitpoints.data, speed=form.speed.data, lvl=form.level.data, str=form.strength.data, dex=form.dexterity.data, con=form.constitution.data, int=form.intelligence.data, wis=form.wisdom.data, cha=form.wisdom.data, race=form.race.data, subrace=form.subrace.data, clas=form.classname.data, subclass=form.subclass.data, old_race=form.race.data, old_subrace=form.subrace.data, old_class=form.classname.data, old_subclass=form.subclass.data)        
    else:
        print("NORMAL")
...
def character_creation():
    ...
    if request.method == "POST" and form.validate():
        ...
        return render_template("add_character.html", message_text=form.errors, name=form.name.data, hp=form.hitpoints.data, speed=form.speed.data, lvl=form.level.data, str=form.strength.data, dex=form.dexterity.data, con=form.constitution.data, int=form.intelligence.data, wis=form.wisdom.data, cha=form.wisdom.data, old_race=form.race.data, old_subrace=form.subrace.data, old_class=form.classname.data, old_subclass=form.subclass.data)
