...
class CharacterValidation(FlaskForm):
    ...
    intelligence = IntegerField('Intelligence', [DataRequired(message="Your character must have an intelligence score! Please enter your intelligence."), NumberRange(min=1, max=30, message="A character's intellignece must be between 1 and 30. Please enter a number within that range.")])
